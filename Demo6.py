...
class MyWindow:
    def __init__(self, window):
        ...
        self.btn1 = Button(window, text="Multiplication(*)",command=self.multiply)
        self.btn1.place(x=220, y=200)
        self.btn2 = Button(window, text="Division(/)",command=self.div)
        self.btn2.place(x=340, y=200)
